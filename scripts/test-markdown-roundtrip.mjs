...
const doc = { type: 'doc', content: [
  ...
  { type: 'figure', attrs: { image: 'a.png', width: 10, caption: '一张图', captionEn: 'A figure', label: 'fig:x', placement: 'none', breakable: 'auto', subs: '[]', columns: 2, subMode: 'under' } },
  { type: 'figure', attrs: { image: 'a.png', width: 8, caption: '总题', captionEn: 'Total', label: 'fig:sub', placement: 'none', breakable: 'auto', subs: JSON.stringify([{ image: 'a.png', width: 6, caption: '子一', captionEn: 'Sub 1' }, { image: 'b.png', width: 6, caption: '子二', captionEn: '' }]), columns: 2, subMode: 'under' } },
  ...
  { type: 'tableFigure', attrs: { caption: '一张表', captionEn: 'A table', label: 'tab:t', fit: 'window', colWidth: 2.5, placement: 'none', breakable: 'auto' }, content: [{ type: 'table', content: [
