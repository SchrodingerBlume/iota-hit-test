...
export const SWITCHES: SwitchDef<any>[] = [
  ...
  {
    key: 'subcaptionNumbering',
    label: t("分图号写法"),
    hint: t("分图题与引用里的 (a)"),
    choices: [
      { value: '(a)', label: '(a)' }, { value: 'a', label: 'a' }, { value: 'a.', label: 'a.' }, { value: '（a）', label: '（a）' },
      { value: '(A)', label: '(A)' }, { value: 'A', label: 'A' }, { value: '(1)', label: '(1)' }, { value: '1', label: '1' },
    ],
    group: t("题注与编号"),
    place: 'body',
    resolve: () => ({ value: '(a)', reason: t("按范例：半角括号小写字母") }),
  },
  {
    key: 'subcaptionSeparator',
    label: t("连排分图题分隔"),
    hint: t("分图题连排在图题之下时，各题之间的分隔"),
    choices: [
      { value: ';', label: t("分号 ;") }, { value: '；', label: t("全角分号 ；") }, { value: ',', label: t("逗号 ,") }, { value: '，', label: t("全角逗号 ，") }, { value: ' ', label: t("空格") },
    ],
    group: t("题注与编号"),
    place: 'body',
    resolve: () => ({ value: ';', reason: t("按范例：分号") }),
  },
  {
    key: 'subcaptionGap',
    label: t("连排分图题间距"),
    hint: t("图题与连排分图题之间"),
    choices: [
      { value: 'none', label: t("不留") }, { value: '0.5em', label: t("半个字") }, { value: '1em', label: t("一个字") },
    ],
    group: t("题注与编号"),
    place: 'body',
    resolve: () => ({ value: 'none', reason: t("按模板：紧接图题") }),
  },
  {
  ...
  },
  {
    ...
    group: t("参考文献"),
    place: 'bibliography',
    resolve: () => ({ value: 'numeric', reason: t("指南：顺序编码制，正文上标 [1]") }),
  },
  {
    key: 'bibVersion',
    label: t("国标版本"),
    hint: t("GB/T 7714—2015 或 2025"),
    choices: [
  ...
  },
  {
    ...
    hint: t("上标或行内"),
    choices: [
      { value: 'super', label: t("上标") },
      { value: 'inline', label: t("行内") },
    ],
    group: t("参考文献"),
    place: 'bibliography',
    resolve: (s) => (resolveSwitch<string>(SWITCHES.find((d) => d.key === 'bibStyle')!, s).effective === 'author-date'
      ? { value: 'inline', reason: t("著者-出版年制行内（张三，2020）") }
      : { value: 'super', reason: t("顺序编码制上标 [1]") }),
    applies: (s) => s.bibStyle !== 'foot',
  },
  {
    key: 'bibBracket',
    label: t("方括号"),
    hint: t("编号与文献类型标识的方括号"),
    choices: [
      { value: 'full', label: t("全角 ［1］［M］") },
      { value: 'half', label: t("半角 [1] [M]") },
    ],
    group: t("参考文献"),
    place: 'bibliography',
    resolve: (s) => (s.category === 'hass' ? { value: 'half', reason: t("人文社科档半角") } : { value: 'full', reason: t("理工档全角") }),
  },
  {
    key: 'bibAuthors',
    label: t("责任者"),
    hint: t("超过 3 位时截断"),
    choices: [
      { value: 'three', label: t("前 3 位，余者「等」") },
      { value: 'all', label: t("全部列出") },
    ],
    group: t("参考文献"),
    place: 'bibliography',
    resolve: () => ({ value: 'three', reason: t("国标：不超过 3 位全列，超过只列前 3 位加「等 / et al」") }),
  },
  {
    key: 'bibUrls',
    label: t("网址与 DOI"),
  ...
  },
  {
    ...
    group: t("参考文献"),
    place: 'bibliography',
    resolve: () => ({ value: 'pinyin', reason: t("默认拼音序") }),
    applies: (s) => s.bibStyle === 'author-date',
  },
  {
...
export const defaultSettings = (): Settings => ({
  ...
  subcaptionNumbering: 'auto',
  subcaptionSeparator: 'auto',
  subcaptionGap: 'auto',
