...
const body: RichDoc = {
  ...
  content: [
    ...
    { type: 'theorem', attrs: { kind: 'definition', note: '渗透率', uid: 'perm', label: 'thm:perm' }, content: [p(t('单位压力梯度下流体通过单位面积多孔质材料的体积流量与流体黏度之积，称为该材料的渗透率。'))] },
    { type: 'theorem', attrs: { kind: 'proposition', note: '', uid: 'darcy', label: 'thm:darcy' }, content: [p(t('渗透率只与多孔质材料的结构有关，与流体的性质无关。'))] },
    { type: 'theorem', attrs: { kind: 'proof', note: '', uid: 'darcy-proof' }, content: [p(t('由'), { type: 'ref', attrs: { target: 'thm:perm' } }, t('与Darcy定律即得。'))] },
