...
export class RenderPageImageOptions {
    ...
    get window_hi_x(): number | undefined;
    set window_hi_x(value: number | null | undefined);
    get window_hi_y(): number | undefined;
    set window_hi_y(value: number | null | undefined);
    get window_lo_x(): number | undefined;
    set window_lo_x(value: number | null | undefined);
    get window_lo_y(): number | undefined;
    set window_lo_y(value: number | null | undefined);
}
...
export class TypstRenderer {
    ...
    create_worker(w: Worker): Promise<TypstWorker>;
    create_worker_bridge(): WorkerBridge;
    get_customs(session: RenderSession): Array<any> | undefined;
    hit_canvas_page_bound(ses: RenderSession, page_off: number, x: number, y: number): any;
...
export class TypstWorker {
    ...
    manipulate_data(action: string, data: Uint8Array): Promise<any>;
    render_canvas(actions: Uint8Array, canvas_list: HTMLCanvasElement[], data: RenderPageImageOptions[]): Promise<any>;
}
...
export interface InitOutput {
    ...
    readonly __wbg_workercore_free: (a: number, b: number) => void;
    ...
    readonly workerbridge_send: (a: number, b: number) => void;
    ...
    readonly renderpageimageoptions_set_window_hi_x: (a: number, b: number) => void;
    readonly renderpageimageoptions_set_window_hi_y: (a: number, b: number) => void;
    readonly renderpageimageoptions_set_window_lo_x: (a: number, b: number) => void;
    readonly renderpageimageoptions_set_window_lo_y: (a: number, b: number) => void;
    readonly renderpageimageoptions_window_hi_x: (a: number) => number;
    readonly renderpageimageoptions_window_hi_y: (a: number) => number;
    readonly renderpageimageoptions_window_lo_x: (a: number) => number;
    readonly renderpageimageoptions_window_lo_y: (a: number) => number;
    ...
    readonly typstrenderer_hit_canvas_page_bound: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
    ...
    readonly __wasm_bindgen_func_elem_4273: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_4267: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_661: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_1303: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_1305: (a: number, b: number) => void;
