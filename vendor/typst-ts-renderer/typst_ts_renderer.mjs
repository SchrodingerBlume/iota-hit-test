...
export class RenderPageImageOptions {
    ...
    /**
     * @param {number | null} [window_hi_x]
     */
    set window_hi_x(window_hi_x) {
        if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.__wbg_ptr);
        if (!isLikeNone(window_hi_x)) {
            _assertNum(window_hi_x);
        }
        wasm.renderpageimageoptions_set_window_hi_x(this.__wbg_ptr, isLikeNone(window_hi_x) ? 0x100000001 : Math.fround(window_hi_x));
    }
    /**
     * @param {number | null} [window_hi_y]
     */
    set window_hi_y(window_hi_y) {
        if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.__wbg_ptr);
        if (!isLikeNone(window_hi_y)) {
            _assertNum(window_hi_y);
        }
        wasm.renderpageimageoptions_set_window_hi_y(this.__wbg_ptr, isLikeNone(window_hi_y) ? 0x100000001 : Math.fround(window_hi_y));
    }
    /**
     * @param {number | null} [window_lo_x]
     */
    set window_lo_x(window_lo_x) {
        if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.__wbg_ptr);
        if (!isLikeNone(window_lo_x)) {
            _assertNum(window_lo_x);
        }
        wasm.renderpageimageoptions_set_window_lo_x(this.__wbg_ptr, isLikeNone(window_lo_x) ? 0x100000001 : Math.fround(window_lo_x));
    }
    /**
     * @param {number | null} [window_lo_y]
     */
    set window_lo_y(window_lo_y) {
        if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.__wbg_ptr);
        if (!isLikeNone(window_lo_y)) {
            _assertNum(window_lo_y);
        }
        wasm.renderpageimageoptions_set_window_lo_y(this.__wbg_ptr, isLikeNone(window_lo_y) ? 0x100000001 : Math.fround(window_lo_y));
    }
    /**
     * @returns {number | undefined}
     */
    get window_hi_x() {
        if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.__wbg_ptr);
        const ret = wasm.renderpageimageoptions_window_hi_x(this.__wbg_ptr);
        return ret === 0x100000001 ? undefined : ret;
    }
    /**
     * @returns {number | undefined}
    ...
    get window_hi_y() {
        if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.__wbg_ptr);
        const ret = wasm.renderpageimageoptions_window_hi_y(this.__wbg_ptr);
        return ret === 0x100000001 ? undefined : ret;
    }
    /**
     * @returns {number | undefined}
    ...
    get window_lo_x() {
        if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.__wbg_ptr);
        const ret = wasm.renderpageimageoptions_window_lo_x(this.__wbg_ptr);
        return ret === 0x100000001 ? undefined : ret;
    }
    /**
     * @returns {number | undefined}
    ...
    get window_lo_y() {
        if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.__wbg_ptr);
        const ret = wasm.renderpageimageoptions_window_lo_y(this.__wbg_ptr);
        return ret === 0x100000001 ? undefined : ret;
    }
}
...
export class TypstRenderer {
    ...
    create_worker(w) {
        if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.__wbg_ptr);
        const ret = wasm.typstrenderer_create_worker(this.__wbg_ptr, addHeapObject(w));
        return takeObject(ret);
    }
    /**
     ...
     * @returns {any}
     */
    hit_canvas_page_bound(ses, page_off, x, y) {
        try {
            if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            _assertNum(this.__wbg_ptr);
            ...
            _assertNum(page_off);
            wasm.typstrenderer_hit_canvas_page_bound(retptr, this.__wbg_ptr, ses.__wbg_ptr, page_off, x, y);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
...
export class TypstWorker {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(TypstWorker.prototype);
        obj.__wbg_ptr = ptr;
        TypstWorkerFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
    ...
    manipulate_data(action, data) {
        try {
            ...
            const ptr0 = passStringToWasm0(action, wasm.__wbindgen_export, wasm.__wbindgen_export2);
            const len0 = WASM_VECTOR_LEN;
            wasm.typstworker_manipulate_data(retptr, this.__wbg_ptr, ptr0, len0, addHeapObject(data));
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
     ...
     * @param {HTMLCanvasElement[]} canvas_list
     * @param {RenderPageImageOptions[]} data
     * @returns {Promise<any>}
     */
    render_canvas(actions, canvas_list, data) {
        try {
            if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            _assertNum(this.__wbg_ptr);
            const ptr0 = passArray8ToWasm0(actions, wasm.__wbindgen_export);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passArrayJsValueToWasm0(canvas_list, wasm.__wbindgen_export);
            const len1 = WASM_VECTOR_LEN;
            const ptr2 = passArrayJsValueToWasm0(data, wasm.__wbindgen_export);
...
export class WorkerBridge {
    ...
    send(msg) {
        if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.__wbg_ptr);
        wasm.workerbridge_send(this.__wbg_ptr, addHeapObject(msg));
    }
}
...
export class WorkerCore {
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WorkerCoreFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_workercore_free(ptr, 0);
    }
}
if (Symbol.dispose) WorkerCore.prototype[Symbol.dispose] = WorkerCore.prototype.free;
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_all_c695858ecd245d92: function() { return logError(function (arg0) {
        ...
        __wbg_createLinearGradient_1ecf06dc64e02f68: function() { return logError(function (arg0, arg1, arg2, arg3, arg4) {
            const ret = getObject(arg0).createLinearGradient(arg1, arg2, arg3, arg4);
            return addHeapObject(ret);
        }, arguments); },
        __wbg_createLinearGradient_3a499fcff07912a0: function() { return logError(function (arg0, arg1, arg2, arg3, arg4) {
            const ret = getObject(arg0).createLinearGradient(arg1, arg2, arg3, arg4);
            return addHeapObject(ret);
        }, arguments); },
        ...
        __wbg_createRadialGradient_a14de6a244fbfc5b: function() { return handleError(function (arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
            const ret = getObject(arg0).createRadialGradient(arg1, arg2, arg3, arg4, arg5, arg6);
            return addHeapObject(ret);
        }, arguments); },
        ...
        __wbg_instanceof_CanvasGradient_db014859ecbe0aac: function() { return logError(function (arg0) {
            let result;
            try {
                result = getObject(arg0) instanceof CanvasGradient;
            } catch (_) {
                result = false;
            }
            const ret = result;
        ...
        __wbg_instanceof_DedicatedWorkerGlobalScope_408ad165950810a8: function() { return logError(function (arg0) {
            let result;
            try {
        ...
        __wbg_log_dcafc0b007a05a1e: function() { return logError(function (arg0, arg1, arg2) {
        ...
        __wbg_new_036bd6cd9cea9e73: function() { return logError(function (arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return __wasm_bindgen_func_elem_4267(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
        ...
        __wbg_pagesinfo_new: function() { return logError(function (arg0) {
            const ret = PagesInfo.__wrap(arg0);
            return addHeapObject(ret);
        }, arguments); },
        ...
        __wbg_set_fillStyle_7761d65f6bdd9770: function() { return logError(function (arg0, arg1) {
            getObject(arg0).fillStyle = getObject(arg1);
        }, arguments); },
        __wbg_set_fillStyle_a6dc6303c382ed50: function() { return logError(function (arg0, arg1) {
            getObject(arg0).fillStyle = getObject(arg1);
        }, arguments); },
        ...
        __wbg_set_onmessage_9d59339e7810516a: function() { return logError(function (arg0, arg1) {
        ...
        __wbg_set_strokeStyle_bbc3b0993f3f6b22: function() { return logError(function (arg0, arg1) {
            getObject(arg0).strokeStyle = getObject(arg1);
        }, arguments); },
        __wbg_set_strokeStyle_e2c4fc55952f51af: function() { return logError(function (arg0, arg1, arg2) {
            getObject(arg0).strokeStyle = getStringFromWasm0(arg1, arg2);
        }, arguments); },
        __wbg_set_strokeStyle_f6fe7679b97d01bc: function() { return logError(function (arg0, arg1) {
            getObject(arg0).strokeStyle = getObject(arg1);
        }, arguments); },
        ...
        __wbg_transferControlToOffscreen_bf653da3993156b3: function() { return handleError(function (arg0) {
        ...
        __wbg_typstworker_new: function() { return logError(function (arg0) {
            const ret = TypstWorker.__wrap(arg0);
            return addHeapObject(ret);
        }, arguments); },
        ...
        __wbindgen_cast_0000000000000003: function() { return logError(function (arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [Externref], shim_idx: 570, ret: Unit, inner_ret: Some(Unit) }, mutable: false }) -> Externref`.
            const ret = makeClosure(arg0, arg1, __wasm_bindgen_func_elem_1303);
            return addHeapObject(ret);
        }, arguments); },
        __wbindgen_cast_0000000000000004: function() { return logError(function (arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [], shim_idx: 572, ret: Unit, inner_ret: Some(Unit) }, mutable: false }) -> Externref`.
            const ret = makeClosure(arg0, arg1, __wasm_bindgen_func_elem_1305);
            return addHeapObject(ret);
        }, arguments); },
...
//#endregion
function __wasm_bindgen_func_elem_1305(arg0, arg1) {
    _assertNum(arg0);
    _assertNum(arg1);
    wasm.__wasm_bindgen_func_elem_1305(arg0, arg1);
}
...
function __wasm_bindgen_func_elem_1303(arg0, arg1, arg2) {
    _assertNum(arg0);
    _assertNum(arg1);
    wasm.__wasm_bindgen_func_elem_1303(arg0, arg1, addHeapObject(arg2));
}
...
function __wasm_bindgen_func_elem_4267(arg0, arg1, arg2, arg3) {
    _assertNum(arg0);
    _assertNum(arg1);
    wasm.__wasm_bindgen_func_elem_4267(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
const WorkerCoreFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_workercore_free(ptr >>> 0, 1));
