...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_39899: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_39893: (a: number, b: number, c: number, d: number) => void;
