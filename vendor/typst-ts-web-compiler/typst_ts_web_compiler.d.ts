...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_39896: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_39890: (a: number, b: number, c: number, d: number) => void;
