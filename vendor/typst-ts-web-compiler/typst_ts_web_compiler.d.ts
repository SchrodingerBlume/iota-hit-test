...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_39925: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_39919: (a: number, b: number, c: number, d: number) => void;
