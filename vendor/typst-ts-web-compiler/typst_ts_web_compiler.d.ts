...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_39908: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_39902: (a: number, b: number, c: number, d: number) => void;
