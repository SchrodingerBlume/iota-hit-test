...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_39836: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_39830: (a: number, b: number, c: number, d: number) => void;
