...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_39887: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_39881: (a: number, b: number, c: number, d: number) => void;
