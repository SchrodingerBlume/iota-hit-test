...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_39895: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_39889: (a: number, b: number, c: number, d: number) => void;
