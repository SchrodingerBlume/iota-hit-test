...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_39888: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_39882: (a: number, b: number, c: number, d: number) => void;
