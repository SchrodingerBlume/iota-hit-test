...
export const typstcompiler_evict: (a: number, b: number) => void;
...
export const typstcompileworld_glyph_map: (a: number, b: number) => void;
...
export const __wasm_bindgen_func_elem_39888: (a: number, b: number, c: number, d: number) => void;
export const __wasm_bindgen_func_elem_39882: (a: number, b: number, c: number, d: number) => void;
